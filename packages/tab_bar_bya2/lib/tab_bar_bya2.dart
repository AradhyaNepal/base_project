...
class TabBarByA2 extends StatefulWidget implements PreferredSizeWidget {
  TabBarByA2({
    Key? key,
    required this.tabs,
    this.controller,
  ...
  @override
  _TabBarByA2State createState() => _TabBarByA2State();
}

class _TabBarByA2State extends State<TabBarByA2>
  ...
  @override
  void didUpdateWidget(TabBarByA2 oldWidget) {
  ...
  Widget _buildButton(
    ...
    return Padding(
      ...
      child: TextButton(
        onPressed: () {
          if(widget.isDisabled?.call(index)==true)return;
